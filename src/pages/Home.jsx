  ...
  return (
    <div className="space-y-16">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        {/* Content */}
        <div className="relative container text-center text-white space-y-8 z-10 px-4">
          <motion.h1 
          ...
          <motion.p 
            className="text-lg md:text-xl max-w-2xl mx-auto text-secondary-200"
          ...
          >
            <Link
              to="/properties"
              className="btn px-8 py-3 text-lg group"
            >
              Explore Properties
              <FiArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
            </Link>
            <button className="btn-secondary px-8 py-3 text-lg backdrop-blur-sm">
